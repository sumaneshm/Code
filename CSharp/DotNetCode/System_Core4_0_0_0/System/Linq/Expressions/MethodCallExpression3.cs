...
namespace System.Linq.Expressions
{
  internal class MethodCallExpression3 : MethodCallExpression, IArgumentProvider
  {
    ...
    {
      if (args != null)
        return Expression.Call(this.Method, args[0], args[1], args[2]);
      else
        return Expression.Call(this.Method, Expression.ReturnObject<Expression>(this._arg0), this._arg1, this._arg2);
    }
  }
}
